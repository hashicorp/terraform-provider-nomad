...
func resourceDynamicHostVolumeRegister() *schema.Resource {
	return &schema.Resource{
		Create: resourceDynamicHostVolumeWriteRegister,
		Update: resourceDynamicHostVolumeWriteRegister,
...
func resourceDynamicHostVolumeWriteRegister(d *schema.ResourceData, meta any) error {
