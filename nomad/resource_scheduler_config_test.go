		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("nomad_scheduler_config.config", "system_enabled", "true"),
					resource.TestCheckResourceAttr("nomad_scheduler_config.config", "batch_enabled", "true"),
					resource.TestCheckResourceAttr("nomad_scheduler_config.config", "service_enabled", "true"),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("nomad_scheduler_config.config", "system_enabled", "false"),
					resource.TestCheckResourceAttr("nomad_scheduler_config.config", "batch_enabled", "false"),
					resource.TestCheckResourceAttr("nomad_scheduler_config.config", "service_enabled", "false"),
				),
			},
		},
	})
