...
func resourceDynamicHostVolumeCreate() *schema.Resource {
	return &schema.Resource{
		Create: resourceDynamicHostVolumeWriteCreate,
		Update: resourceDynamicHostVolumeWriteCreate,
...
func resourceDynamicHostVolumeWriteCreate(d *schema.ResourceData, meta any) error {
