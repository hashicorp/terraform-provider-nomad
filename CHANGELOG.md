...
* resource/nomad_job: migrate to Plugin Framework and improve drift detection by using Nomad's `PlanOpts` in `ModifyPlan`. ([#637](https://github.com/hashicorp/terraform-provider-nomad/pull/637))
...
* **New Data Source**: `nomad_nodes` to list Nomad nodes with optional prefix, filter, os, and resources parameters ([#579](https://github.com/hashicorp/terraform-provider-nomad/pull/579))
