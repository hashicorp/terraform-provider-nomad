...
* resource/nomad_variable: Fix `missing variable path` error when importing a `nomad_variable` resource. ([#649](https://github.com/hashicorp/terraform-provider-nomad/pull/649))
