...
IMPROVEMENTS:
* **New Resources**: `nomad_dynamic_host_volume_create` and `nomad_dynamic_host_volume_register` to create and register dynamic host volumes ([#498](https://github.com/hashicorp/terraform-provider-nomad/pull/498))
