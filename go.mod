...
replace (
	...
	// TODO: remove when https://github.com/hashicorp/nomad/pull/28138 is merged
	// and ready to ship in Nomad core
	github.com/hashicorp/nomad => github.com/hashicorp/nomad v1.11.0-rc.1.0.20260617153319-5938e9f2e39b
)
