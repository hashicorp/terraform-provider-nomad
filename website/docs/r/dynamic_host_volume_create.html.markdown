...
---
layout: "nomad"
page_title: "Nomad: nomad_dynamic_host_volume_create"
sidebar_current: "docs-nomad-resource-dynamic-host-volume-create"
description: |-
  Manages the lifecycle of creating and deleting dynamic host volumes.
---

# nomad_dynamic_host_volume_create
...
```hcl
resource nomad_dynamic_host_volume_create "example" {
  name      = "example"
  namespace = "prod"
  plugin_id = "mkdir"
